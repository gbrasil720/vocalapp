    ...
    <>
      ...
      <div className="relative w-screen h-[100vh] z-40 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 pointer-events-none">
        <div className="pointer-events-auto">
          ...
          <h1 className="font-['Satoshi'] font-medium text-3xl sm:text-4xl md:text-5xl lg:text-7xl bg-gradient-to-r from-[#d856bf] via-[#c247ac] to-[#03b3c3] bg-clip-text text-transparent leading-tight drop-shadow-lg max-w-4xl px-2">
            The best speech-to-text experience you'll ever have.
          </h1>
          <p className="font-['Inter'] font-normal text-lg sm:text-xl lg:text-2xl mt-4 sm:mt-6 text-[#03b3c3]/90 max-w-3xl leading-relaxed text-center mx-auto px-4">
