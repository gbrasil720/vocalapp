              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <p className="text-gray-300 leading-relaxed text-lg">
                    We're currently in closed beta testing. Payment processing
                    is not available at this time. All beta users receive free
                ...
                <SpotlightCard className="bg-transparent backdrop-blur-xl">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <HugeiconsIcon
                      ...
                      size={32}
                      className={
                        isBetaUser ? 'text-[#03b3c3]' : 'text-gray-500'
                      }
                    />
                  </div>
                ...
                <SpotlightCard className="bg-transparent backdrop-blur-xl">
                  ...
                  <div className="pt-4 border-t border-white/10">
                    <p className="text-xs text-gray-400">
                      Enjoy unlimited testing during the beta period. All
                      features are available to you at no cost while we refine
                      the platform.
                    </p>
                  </div>
                </SpotlightCard>
