      ...
      if (pendingPack) {
        ...
        try {
          ...
          if (response.ok) {
            ...
            setMessage(
              'Subscription successful! Your plan will be updated shortly.'
            )
            setStatus('success')
          }
        } catch (e) {
              ...
              <div className="flex justify-between items-end pb-4 border-b border-white/10">
                <div>
                  ...
                  <span className="text-3xl font-bold text-white">
                    {(
                      (details.data.total_amount || details.data.amount || 0) /
                      100
